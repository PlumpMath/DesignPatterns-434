...
class GUI:
    ...
    def __init__(self, master):
        ...
        self.frame_header.grid(row =0, column =0, stick = 'n', rowspan = 2, padx = 10, pady = 10, ipadx = 10, ipady = 10)
        self.image = PhotoImage(file = 'download_1_.png')
        ttk.Label(self.frame_header, text = "Image Workflow Control").grid(row =0, column = 0)
        ttk.Label(self.frame_header, image = self.image).grid(row =1, column = 0)
        ...
        self.frame_setDirectory.grid(row = 2, column = 0, padx = 10, pady = 10, stick = 'n')
        ttk.Label(self.frame_setDirectory, text = "Parameters [path] for Set Directory").grid(row = 0, column = 0)
        ...
        checkbuttonRed = ttk.Checkbutton(self.frame_selectChannels, text = 'RED').grid(row = 1, column = 0)
        checkbuttonBlue = ttk.Checkbutton(self.frame_selectChannels, text = 'BLUE').grid(row = 1, column = 1)
        checkbuttonGreen = ttk.Checkbutton(self.frame_selectChannels, text = 'GREEN').grid(row = 2, column = 0)
        checkbuttonInfraRed = ttk.Checkbutton(self.frame_selectChannels, text = 'INFRARED').grid(row = 2, column = 1)


        self.frame_window = ttk.Frame(master, width = 200, height = 300, relief = SUNKEN)
        self.frame_window.grid(row = 0, column = 1, stick = 'n', padx = 10, pady = 10, ipadx = 10, ipady = 10)
        ttk.Label(self.frame_window, text = "Parameters [path] for Window").grid(row = 0, column = 0, columnspan = 2)
        ...
        self.frame_setDirectory = ttk.Frame(master, width = 200, height = 300, relief = SUNKEN)
        self.frame_setDirectory.grid(row = 1, column = 1, stick = 'n', padx = 10, pady = 10, ipadx = 10, ipady = 10)
        ttk.Label(self.frame_setDirectory, text = "Data Compression [PCA] and [CCA]").grid(row = 0, column = 0, columnspan =3)
        ...
        self.frame_superviseDirectory.grid(row = 2, column = 1, rowspan = 2, stick = 'n', padx = 10, pady = 10, ipadx = 10, ipady = 10)
        ttk.Label(self.frame_superviseDirectory, text = "Supervised Classification Parameters").grid(row = 0, column = 0)
        ttk.Label(self.frame_superviseDirectory, text = "Training Shappette for [make signature]").grid(row = 1, column = 0)
        ...
        self.frame_PickMast.grid(row = 0, column = 2, stick = 'n', padx = 10, pady = 10, ipadx = 10, ipady = 10)
        ttk.Label(self.frame_PickMast, wraplength = 200, text = "Parameters [files] for the land cover assesstment [pick mass]component").grid(row = 0, column = 0, columnspan = 2)
        ...
        self.custom.grid(row = 1, column = 2, rowspan = 3, stick = 'n', padx = 10, pady = 10, ipadx = 10, ipady = 10)
        ttk.Label(self.custom, text = "Build custom workflow ").grid(row = 0, column = 0)
        ...
        self.modules = ttk.Frame(self.custom, relief = SUNKEN)
        self.modules.grid(row = 2, column = 0, padx = 10, pady = 10, ipadx = 10, ipady = 10)
        ttk.Label(self.modules, text = "Modules ").grid(row = 0, column = 0)
        ...
        self.textClassificationComments1 = Text(self.modules, width = 15, height = 10).grid(row = 2, column = 0, rowspan = 6)
        ...
        self.frame_workflow.grid(row = 0, column = 3, rowspan = 4, stick = 'n', padx = 10, pady = 10, ipadx = 10, ipady = 10)
        ttk.Label(self.frame_workflow, text = "Workflows ").grid(row = 1, column = 0)
        workflow = StringVar()
        ttk.Radiobutton(self.frame_workflow, text = 'Unsupervised [k means]',variable = workflow).grid(row =2 , column = 0)
        ttk.Radiobutton(self.frame_workflow, text = 'Supervised [multiple + error messages]' ,variable = workflow).grid(row =3 , column = 0)
        ttk.Radiobutton(self.frame_workflow, text = 'Land cover assesstment' ,variable = workflow).grid(row =4 , column = 0)
        ttk.Radiobutton(self.frame_workflow, text = 'Customized workflow' ,variable = workflow).grid(row =5 , column = 0)
        ttk.Radiobutton(self.frame_workflow, text = 'Deserialize load from xml ' ,variable = workflow).grid(row =6 , column = 0)
        ...
        ttk.Button(self.framebuttons, text = 'Update Parameters').grid(row = 0, column = 1)
        ttk.Label(self.framebuttons, text = "2 ").grid(row = 1, column = 0)
        ttk.Button(self.framebuttons, text = 'Validate Parameters').grid(row = 1, column = 1)
        ttk.Label(self.framebuttons, text = "3 ").grid(row = 2, column = 0)
        ttk.Button(self.framebuttons, text = 'View workflow description (opt)').grid(row = 2, column = 1)
        ttk.Label(self.framebuttons, text = "4 ").grid(row = 3, column = 0)
        ttk.Button(self.framebuttons, text = 'Execute workflow').grid(row = 3, column = 1)
        ttk.Label(self.framebuttons, text = "5 ").grid(row = 4, column = 0)
        ttk.Button(self.framebuttons, text = 'Report Workflow (transform XML').grid(row = 4, column = 1)
        ttk.Label(self.framebuttons, text = "6 ").grid(row = 5, column = 0)
        ttk.Button(self.framebuttons, text = 'Exit Application').grid(row = 5, column = 1)
